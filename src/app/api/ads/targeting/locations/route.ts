...
import { searchLocations } from '@/lib/meta-ads';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const type = searchParams.get('type') || 'adgeolocation';
    ...
    const results = await searchLocations(facebookAccountId, query, type);
